@echo off
chcp 65001 >nul 2>&1
title Equipment Counter - Web (v2: VOR DOCX/XLSX)
...
:: Check and install dependencies (incl. python-docx)
%PYTHON% -c "import fastapi; import uvicorn; import pdfplumber; import docx" >nul 2>&1
if %errorlevel% neq 0 (
...
echo  Endpoints: /export_xlsx_v2, /export_docx, /cache_vor
